...
public class MainActivity2 extends AppCompatActivity implements OnMapReadyCallback, Asynchtask {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lat = -1.0172276985611874;  lng = -79.46035604072723;       radio = 1;
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        CameraUpdate camUpd1 = CameraUpdateFactory.newLatLngZoom(new LatLng(lat, lng), 13);map.moveCamera(camUpd1);
